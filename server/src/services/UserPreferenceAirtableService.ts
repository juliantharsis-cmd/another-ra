...
/**
 * UserPreference Airtable Service
 * 
 * Auto-generated service for User Preference table
 */
export class UserPreferenceAirtableService {
  ...
  constructor() {
    ...
    this.tableName = 'User Preference'
