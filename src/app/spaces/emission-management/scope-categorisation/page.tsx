...
import { scopeCategorisationConfig } from '@/components/templates/configs/scopeCategorisationConfig'

export default function ScopeCategorisationPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-50 overflow-hidden" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <ListDetailTemplate config={scopeCategorisationConfig} />
      </div>
    </div>
  )
}
