...
import { efDetailedGConfig } from '@/components/templates/configs/efDetailedGConfig'

export default function EFDetailedGPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-50 overflow-hidden" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <ListDetailTemplate config={efDetailedGConfig} />
      </div>
    </div>
  )
}
