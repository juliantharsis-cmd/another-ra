...
import { standardECMCatalogConfig } from '@/components/templates/configs/standardECMCatalogConfig'

export default function StandardECMCatalogPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-50 overflow-hidden" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <ListDetailTemplate config={standardECMCatalogConfig} />
      </div>
    </div>
  )
}
