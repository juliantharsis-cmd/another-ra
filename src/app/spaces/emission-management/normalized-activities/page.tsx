...
import { normalizedActivityConfig } from '@/components/templates/configs/normalizedActivityConfig'

export default function NormalizedActivitiesPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-50 overflow-hidden" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <ListDetailTemplate config={normalizedActivityConfig} />
      </div>
    </div>
  )
}
