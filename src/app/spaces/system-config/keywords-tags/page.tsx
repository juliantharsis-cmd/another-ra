...
import { keywordsTagsConfig } from '@/components/templates/configs/keywordsTagsConfig'

export default function KeywordsTagsPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-50 overflow-hidden" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <ListDetailTemplate config={keywordsTagsConfig} />
      </div>
    </div>
  )
}
