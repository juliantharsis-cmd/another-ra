...
import { activityDensityConfig } from '@/components/templates/configs/activityDensityConfig'

export default function ActivityDensityPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-gray-50 overflow-hidden" style={{ margin: 0, padding: 0 }}>
      ...
      >
        <ListDetailTemplate config={activityDensityConfig} />
      </div>
    </div>
  )
}
